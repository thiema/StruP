...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>String To Error Control Map</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link easyflow.util.maps.impl.StringToErrorControlMapImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link easyflow.util.maps.impl.StringToErrorControlMapImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StringToErrorControlMapImpl extends EObjectImpl implements BasicEMap.Entry<String,ErrorControl> {
	/**
	 ...
	 * @generated
	 */
	protected StringToErrorControlMapImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MapsPackage.Literals.STRING_TO_ERROR_CONTROL_MAP;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapsPackage.STRING_TO_ERROR_CONTROL_MAP__KEY, oldKey, key));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MapsPackage.STRING_TO_ERROR_CONTROL_MAP__KEY:
				return getTypedKey();
