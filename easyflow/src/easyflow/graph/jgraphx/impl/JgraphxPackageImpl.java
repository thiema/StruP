...
public class JgraphxPackageImpl extends EPackageImpl implements JgraphxPackage {
	...
	public void initializePackageContents() {
		...
		abstractGraphEClass.getESuperTypes().add(theGraphPackage.getDefaultGraph());
		traversalEventGraphEClass.getESuperTypes().add(theGraphPackage.getDefaultGraph());
		preprocessingGraphEClass.getESuperTypes().add(theGraphPackage.getDefaultGraph());
		toolDependencyGraphEClass.getESuperTypes().add(theGraphPackage.getDefaultGraph());
		executionGraphEClass.getESuperTypes().add(theGraphPackage.getDefaultGraph());
		subGraphEClass.getESuperTypes().add(theGraphPackage.getDefaultGraph());
