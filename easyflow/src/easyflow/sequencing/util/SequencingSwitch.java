 ...
 * @generated
 */
public class SequencingSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SequencingPackage.REF_BASED_PROJECT_META_DATA: {
				RefBasedProjectMetaData refBasedProjectMetaData = (RefBasedProjectMetaData)theEObject;
				T result = caseRefBasedProjectMetaData(refBasedProjectMetaData);
				if (result == null) result = caseIProjectMetaData(refBasedProjectMetaData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SequencingPackage.META_DATA: {
				MetaData metaData = (MetaData)theEObject;
				T result = caseMetaData(metaData);
				if (result == null) result = caseDefaultMetaData(metaData);
				if (result == null) result = caseIMetaData(metaData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ref Based Project Meta Data</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ref Based Project Meta Data</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRefBasedProjectMetaData(RefBasedProjectMetaData object) {
		return null;
	}
