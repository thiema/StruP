 ...
 * <ul>
 *   <li>{@link easyflow.ui.impl.ResequencingProjectImpl#getRefBasedProjectMetaData <em>Ref Based Project Meta Data</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResequencingProjectImpl extends DefaultProjectImpl implements ResequencingProject {
	...
	protected EClass eStaticClass() {
		return UiPackage.Literals.RESEQUENCING_PROJECT;
	}
	...
	public EList<RefBasedProjectMetaData> getRefBasedProjectMetaData() {
		if (refBasedProjectMetaData == null) {
			refBasedProjectMetaData = new EObjectResolvingEList<RefBasedProjectMetaData>(RefBasedProjectMetaData.class, this, UiPackage.RESEQUENCING_PROJECT__REF_BASED_PROJECT_META_DATA);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UiPackage.RESEQUENCING_PROJECT__REF_BASED_PROJECT_META_DATA:
