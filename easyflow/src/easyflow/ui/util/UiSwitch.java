...
public class UiSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UiPackage.IPROJECT: {
				IProject iProject = (IProject)theEObject;
				T result = caseIProject(iProject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UiPackage.DEFAULT_PROJECT: {
				DefaultProject defaultProject = (DefaultProject)theEObject;
				T result = caseDefaultProject(defaultProject);
				if (result == null) result = caseIProject(defaultProject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
