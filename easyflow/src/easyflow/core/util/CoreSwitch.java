...
public class CoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CorePackage.PREPROCESSING_TASK: {
				PreprocessingTask preprocessingTask = (PreprocessingTask)theEObject;
				T result = casePreprocessingTask(preprocessingTask);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CorePackage.ERROR_INFO: {
				ErrorInfo errorInfo = (ErrorInfo)theEObject;
				T result = caseErrorInfo(errorInfo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Preprocessing Task</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Preprocessing Task</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePreprocessingTask(PreprocessingTask object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Parent Task Result</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Parent Task Result</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseParentTaskResult(ParentTaskResult object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseErrorInfo(ErrorInfo object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tool Match</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tool Match</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseToolMatch(ToolMatch object) {
		return null;
	}
