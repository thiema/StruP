...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Traversal Criterion</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link easyflow.core.impl.TraversalCriterionImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link easyflow.core.impl.TraversalCriterionImpl#getChunks <em>Chunks</em>}</li>
 *   <li>{@link easyflow.core.impl.TraversalCriterionImpl#getChunkSource <em>Chunk Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TraversalCriterionImpl extends GroupingCriterionImpl implements TraversalCriterion {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.TRAVERSAL_CRITERION;
	}
		...
		if (operation != null && operation.eIsProxy()) {
			...
			if (operation != oldOperation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.TRAVERSAL_CRITERION__OPERATION, oldOperation, operation));
			}
		}
		return operation;
	}
	...
	public void setOperation(TraversalOperation newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.TRAVERSAL_CRITERION__OPERATION, oldOperation, operation));
	}
	...
	public EMap<String, TraversalChunk> getChunks() {
		if (chunks == null) {
			chunks = new EcoreEMap<String,TraversalChunk>(CorePackage.Literals.STRING_TO_CHUNK_MAP, StringToChunkMapImpl.class, this, CorePackage.TRAVERSAL_CRITERION__CHUNKS);
		}
		return chunks;
	}
	...
	public void setChunkSource(String newChunkSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.TRAVERSAL_CRITERION__CHUNK_SOURCE, oldChunkSource, chunkSource));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.TRAVERSAL_CRITERION__CHUNKS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.TRAVERSAL_CRITERION__OPERATION:
				if (resolve) return getOperation();
				return basicGetOperation();
			case CorePackage.TRAVERSAL_CRITERION__CHUNKS:
				if (coreType) return getChunks();
				else return getChunks().map();
			case CorePackage.TRAVERSAL_CRITERION__CHUNK_SOURCE:
