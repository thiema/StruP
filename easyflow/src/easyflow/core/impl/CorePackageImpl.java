...
public class CorePackageImpl extends EPackageImpl implements CorePackage {
	 ...
	 * @generated
	 */
	public EOperation getTask__HasMultipleInputsFor__DataPort() {
	 ...
	 * @generated
	 */
	public EOperation getTask__HasMultipleInstancesFor__DataPort() {
	 ...
	 * @generated
	 */
	public EOperation getTask__HasMultipleGroupingsFor__DataPort() {
	 ...
	 * @generated
	 */
	public EOperation getTask__CanProcessMultipleGroupingsFor__Tool_DataPort() {
	...
	public void createPackageContents() {
		...
		createEOperation(taskEClass, TASK___HAS_MULTIPLE_INPUTS_FOR__DATAPORT);
		createEOperation(taskEClass, TASK___HAS_MULTIPLE_INSTANCES_FOR__DATAPORT);
		createEOperation(taskEClass, TASK___HAS_MULTIPLE_GROUPINGS_FOR__DATAPORT);
		...
		createEOperation(taskEClass, TASK___CAN_PROCESS_MULTIPLE_GROUPINGS_FOR__TOOL_DATAPORT);
	...
	public void initializePackageContents() {
		...
		op = initEOperation(getTask__HasMultipleInputsFor__DataPort(), ecorePackage.getEBoolean(), "hasMultipleInputsFor", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theDataPackage.getDataPort(), "dataPort", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getTask__HasMultipleInstancesFor__DataPort(), ecorePackage.getEBoolean(), "hasMultipleInstancesFor", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theDataPackage.getDataPort(), "dataPort", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getTask__HasMultipleGroupingsFor__DataPort(), ecorePackage.getEBoolean(), "hasMultipleGroupingsFor", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theDataPackage.getDataPort(), "dataPort", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getTask__CanProcessMultipleGroupingsFor__Tool_DataPort(), ecorePackage.getEBoolean(), "canProcessMultipleGroupingsFor", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theToolPackage.getTool(), "tool", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theDataPackage.getDataPort(), "dataPort", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEException(op, theEasyflowPackage.getDataPortNotFoundException());
		addEException(op, theEasyflowPackage.getToolNotFoundException());
