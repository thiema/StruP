 ...
 * <ul>
 *   <li>{@link easyflow.core.impl.StringToGroupingInstanceListMapImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link easyflow.core.impl.StringToGroupingInstanceListMapImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringToGroupingInstanceListMapImpl extends EObjectImpl implements BasicEMap.Entry<String,GroupingInstanceList> {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.STRING_TO_GROUPING_INSTANCE_LIST_MAP;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.STRING_TO_GROUPING_INSTANCE_LIST_MAP__KEY, oldKey, key));
	}
	...
	public GroupingInstanceList getTypedValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.STRING_TO_GROUPING_INSTANCE_LIST_MAP__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setTypedValue(GroupingInstanceList newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.STRING_TO_GROUPING_INSTANCE_LIST_MAP__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.STRING_TO_GROUPING_INSTANCE_LIST_MAP__KEY:
				return getTypedKey();
			case CorePackage.STRING_TO_GROUPING_INSTANCE_LIST_MAP__VALUE:
