 ...
 * <ul>
 *   <li>{@link easyflow.core.impl.GroupingCriterionImpl#getId <em>Id</em>}</li>
 *   <li>{@link easyflow.core.impl.GroupingCriterionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link easyflow.core.impl.GroupingCriterionImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link easyflow.core.impl.GroupingCriterionImpl#isMultipleInstances <em>Multiple Instances</em>}</li>
 *   <li>{@link easyflow.core.impl.GroupingCriterionImpl#isSeperateInputPorts <em>Seperate Input Ports</em>}</li>
 *   <li>{@link easyflow.core.impl.GroupingCriterionImpl#getLogger <em>Logger</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GroupingCriterionImpl extends EObjectImpl implements GroupingCriterion {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.GROUPING_CRITERION;
	}
	...
	public void setMultipleInstances(boolean newMultipleInstances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GROUPING_CRITERION__MULTIPLE_INSTANCES, oldMultipleInstances, multipleInstances));
	}
	...
	public void setSeperateInputPorts(boolean newSeperateInputPorts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GROUPING_CRITERION__SEPERATE_INPUT_PORTS, oldSeperateInputPorts, seperateInputPorts));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GROUPING_CRITERION__ID, oldId, id));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GROUPING_CRITERION__DESCRIPTION, oldDescription, description));
	}
	...
	public void setMode(String newMode) {
		...
		mode = newMode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GROUPING_CRITERION__MODE, oldMode, mode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.GROUPING_CRITERION__ID:
				return getId();
			case CorePackage.GROUPING_CRITERION__DESCRIPTION:
				return getDescription();
			case CorePackage.GROUPING_CRITERION__MODE:
				return getMode();
			case CorePackage.GROUPING_CRITERION__MULTIPLE_INSTANCES:
				return isMultipleInstances();
			case CorePackage.GROUPING_CRITERION__SEPERATE_INPUT_PORTS:
				return isSeperateInputPorts();
			case CorePackage.GROUPING_CRITERION__LOGGER:
				return getLogger();
		}
