...
public class TestGraphEditor extends BasicGraphEditor
{
	 ...
	 * 
	 */
	public TestGraphEditor(String appTitle, mxGraphComponent component)
	{
	...
	*/
	public static class CustomGraphComponent extends mxGraphComponent
	{
		...
		public CustomGraphComponent(mxGraph graph)
		{
			...
			Document doc = mxUtils.loadDocument(TestGraphEditor.class.getResource(
	...
	public static void main(String[] args)
	{
		...
		TestGraphEditor editor = new TestGraphEditor();
