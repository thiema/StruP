...
public class EasyFlowToolBar_old extends JToolBar
{
	...
	public EasyFlowToolBar_old(final EasyFlowGraphEditor editor, int orientation)
	{
		super(orientation);
		this.editor=editor;
		register();
