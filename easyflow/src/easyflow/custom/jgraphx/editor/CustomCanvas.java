...
public class CustomCanvas extends JFrame
{
	...
	public class SwingCanvas extends mxInteractiveCanvas
	{
		...
		protected JPanel vertexRenderer = new JPanel();
		...
		public void drawVertex(mxCellState state, String label)
		{
			...
			vertexLabel.setText(label);
			JButton button = new JButton("Show More");
			vertexRenderer.add(vertexLabel);
			vertexRenderer.add(button);
