...
public interface PegasusPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int PEGASUS__UNIX = ExecutionPackage.IEXECUTION_SYSTEM_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PEGASUS__SITE_CATALOG = ExecutionPackage.IEXECUTION_SYSTEM_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int PEGASUS__REPLICA_CATALOG = ExecutionPackage.IEXECUTION_SYSTEM_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int PEGASUS__TRANSFORMATION_CATALOG = ExecutionPackage.IEXECUTION_SYSTEM_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int PEGASUS_FEATURE_COUNT = ExecutionPackage.IEXECUTION_SYSTEM_FEATURE_COUNT + 4;
